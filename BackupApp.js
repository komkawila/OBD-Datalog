  ...
  const App = () => {
    ...
    const handleUpdateValueForCharacteristic = (data) => {
      ...
      if (datas.indexOf("IN1=") != -1) {
        // setBatt(parseFloat(datas.substring(len + 1, datas.indexOf(","))));
        setBatt(parseFloat(datas.substring(len + 1, datas.length - 1)));
  
        // setMode(datas.substring(datas.indexOf(",") + 1, datas.length - 1));
        // if (datas.substring(datas.indexOf(",") + 1, datas.length - 1) == '0') {
        //   if (!modeBatt) {
        //     console.log("SET BATTERRY");
        //     setModeBatt(true);
        //     setModeFrp(false);
        //     setModeVfrp(false);
        //   }
        // } else if (datas.substring(datas.indexOf(",") + 1, datas.length - 1) == '1') {
        //   if (!modeFrp) {
        //     setModeBatt(false);
        //     setModeFrp(true);
        //     setModeVfrp(false);
        //   }
        // } else if (datas.substring(datas.indexOf(",") + 1, datas.length - 1) == '2') {
        //   if (!modeVfrp) {
        //     setModeBatt(false);
        //     setModeFrp(false);
        //     setModeVfrp(true);
        //   }
        // }
        // console.log(datas.substring(datas.indexOf(",") + 1, datas.length - 1));
    ...
    return (
      <>
        {/* <View style={ styles.container }>
          <Image source={require('./assets/img/bg.jpg')} style={styles.backgroundImage} />
        ...
        <ImageBackground source={require('./assets/img/bg.jpg')} style={{ width: '100%', height: '100%' }}>
          {/* <View style={{ width: '100%', height: '100%', position: "relative" }}>
            <Image source={require('./assets/img/logopng.png')} style={{ width: '10%', height: '15%', top: 5, left: 5 }}></Image>
            <TouchableOpacity onPress={bluetoothFunc} style={{ width: '10%', height: '15%', position: "absolute", right: 5, top: 5 }}>
              <Image source={require('./assets/img/ble-logo.png')} style={{ width: '100%', height: '100%', position: "absolute", right: 5, top: 5 }}></Image>
            </TouchableOpacity>
  
            <TouchableOpacity onPress={settingFunc} style={{ width: '10%', height: '18%', position: "absolute", right: 5, bottom: 5 }}>
            ...
            <View style={{ width: '50%', position: "absolute", height: '100%' }}>
              ...
              <View style={{ position: "absolute", width: '80%', height: '85%', top: 40, left: 40}}>
                ...
                {modeFrp ? <Speedometer
                  ...
                  noNeedle
                // dangerZone
                // style={{ width: '100%', height: '100%', left: 55, top: 40, position: "absolute" }}
              ...
              <View style={{ marginTop: 30, width: '89%' }}>
                <View style={{ position: "relative", width: '100%', height: '13%', marginBottom: 10 }}>
                  ...
                  <Text style={{
                    ...
                    {batt.toFixed(2)}
                    {/* <Text style={{ color: 'white', fontSize: 15 }}>  V</Text> */}
                  </Text>
                  <Text style={{
                    // backgroundColor: 'red', 
                    width: '15%',
                ...
                <View style={{ position: "relative", width: '100%', height: '13%', marginBottom: 10 }}>
                  ...
                  <Text style={{
                    ...
                    {/* <Text style={{ color: 'white', fontSize: 15 }}>  MPA</Text> */}
                  </Text>
                  <Text style={{
                    // backgroundColor: 'red', 
                    width: '15%',
                ...
                <View style={{ position: "relative", width: '100%', height: '13%', marginBottom: 10 }}>
                  ...
                  <Text style={{
                    ...
                    {topspeed}
                    {/* <Text style={{ color: 'white', fontSize: 15 }}>  km/hr</Text> */}
                  </Text>
                  <Text style={{
                    // backgroundColor: 'red', 
                    width: '15%',
